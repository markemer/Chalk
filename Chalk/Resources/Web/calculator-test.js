...
function myonload()
{
  document.getElementById('logger').innerHTML += '>myonload()<br/>';
  preload();
  document.getElementById('logger').innerHTML += '<myonload()<br/>';
}
...
function myonerror()
{
  document.getElementById('logger').innerHTML += 'MathJax failed to load: ' + err.message + '<br/>';
}
...
var enableDOMLog = true;
var enableConsoleLog = true;
var enableObjCConsoleLog = true;
