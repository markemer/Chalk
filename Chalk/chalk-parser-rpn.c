...
#line 2 "./chalk-parser-rpn.lemon"
#include <assert.h>
#line 3 "./chalk-parser-rpn.lemon"
#include "chalk-parser-rpn.h"
#line 4 "./chalk-parser-rpn.lemon"
#include "CHChalkToken.h"
#line 5 "./chalk-parser-rpn.lemon"
#include "CHParserContext.h"
#line 6 "./chalk-parser-rpn.lemon"
#include "CHParserNode.h"
#line 7 "./chalk-parser-rpn.lemon"
#include "CHParserAssignationNode.h"
#line 8 "./chalk-parser-rpn.lemon"
#include "CHParserAssignationDynamicNode.h"
#line 9 "./chalk-parser-rpn.lemon"
#include "CHParserEnumerationNode.h"
#line 10 "./chalk-parser-rpn.lemon"
#include "CHParserFunctionNode.h"
#line 11 "./chalk-parser-rpn.lemon"
#include "CHParserIdentifierNode.h"
#line 12 "./chalk-parser-rpn.lemon"
#include "CHParserIfThenElseNode.h"
#line 13 "./chalk-parser-rpn.lemon"
#include "CHParserListNode.h"
#line 14 "./chalk-parser-rpn.lemon"
#include "CHParserMatrixNode.h"
#line 15 "./chalk-parser-rpn.lemon"
#include "CHParserMatrixRowNode.h"
#line 16 "./chalk-parser-rpn.lemon"
#include "CHParserOperatorNode.h"
#line 17 "./chalk-parser-rpn.lemon"
#include "CHParserSubscriptNode.h"
#line 18 "./chalk-parser-rpn.lemon"
#include "CHParserValueIndexRangeNode.h"
#line 19 "./chalk-parser-rpn.lemon"
#include "CHParserValueNode.h"
#line 20 "./chalk-parser-rpn.lemon"
#include "CHParserValueNumberNode.h"
#line 21 "./chalk-parser-rpn.lemon"
#include "CHParserValueNumberIntegerNode.h"
#line 22 "./chalk-parser-rpn.lemon"
#include "CHParserValueNumberRealNode.h"
#line 23 "./chalk-parser-rpn.lemon"
#include "CHParserValueNumberIntervalNode.h"
#line 24 "./chalk-parser-rpn.lemon"
#include "CHParserValueNumberPerFractionNode.h"
#line 25 "./chalk-parser-rpn.lemon"
#include "CHParserValueStringNode.h"
#line 26 "./chalk-parser-rpn.lemon"
#include "CHUtils.h"
#line 79 "./chalk-parser-rpn.c"
...
/********* Begin destructor definitions ***************************************/
    case 74: /* context */
{
#line 41 "./chalk-parser-rpn.lemon"

  context = 0;//prevent compile warning

#line 977 "./chalk-parser-rpn.c"
}
      break;
...
#line 1577 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy41 = yylhsminor.yy41;
        break;
      case 4: /* index_range ::= INDEX_RANGE_JOKER */
#line 98 "./chalk-parser-rpn.lemon"
{
...
#line 1586 "./chalk-parser-rpn.c"
  yymsp[0].minor.yy41 = yylhsminor.yy41;
        break;
      case 5: /* real ::= REAL_POSITIVE */
#line 102 "./chalk-parser-rpn.lemon"
{
...
#line 125 "./chalk-parser-rpn.lemon"
{
...
#line 1713 "./chalk-parser-rpn.c"
        break;
      case 22: /* expr ::= expr QUESTION expr ALTERNATE expr */
#line 155 "./chalk-parser-rpn.lemon"
{
...
#line 1790 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 30: /* expr ::= expr OPERATOR_UNCERTAINTY expr */
#line 194 "./chalk-parser-rpn.lemon"
{
...
#line 1801 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 31: /* expr ::= expr expr OPERATOR_PLUS */
#line 200 "./chalk-parser-rpn.lemon"
{
...
#line 1812 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 32: /* expr ::= expr expr OPERATOR_PLUS2 */
#line 206 "./chalk-parser-rpn.lemon"
{
...
#line 1823 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 33: /* expr ::= expr expr OPERATOR_MINUS */
#line 212 "./chalk-parser-rpn.lemon"
{
  yylhsminor.yy173 = [CHParserOperatorNode parserNodeWithToken:yymsp[0].minor.yy0 operator:CHALK_LEMON_RPN_OPERATOR_MINUS];
  [yylhsminor.yy173 addChild:yymsp[-2].minor.yy173];
  [yylhsminor.yy173 addChild:yymsp[-1].minor.yy173];
...
#line 1834 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 34: /* expr ::= expr expr OPERATOR_MINUS2 */
#line 218 "./chalk-parser-rpn.lemon"
{
...
#line 1857 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 37: /* expr ::= expr expr OPERATOR_TIMES2 */
#line 236 "./chalk-parser-rpn.lemon"
{
...
#line 1868 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 38: /* expr ::= expr expr OPERATOR_DIVIDE */
#line 242 "./chalk-parser-rpn.lemon"
{
...
#line 1879 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 39: /* expr ::= expr expr OPERATOR_DIVIDE2 */
#line 248 "./chalk-parser-rpn.lemon"
{
...
#line 1890 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 40: /* expr ::= expr expr OPERATOR_POW */
#line 254 "./chalk-parser-rpn.lemon"
{
...
#line 1901 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 41: /* expr ::= expr expr OPERATOR_POW2 */
#line 260 "./chalk-parser-rpn.lemon"
{
...
#line 1912 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 42: /* expr ::= expr OPERATOR_DEGREE */
#line 266 "./chalk-parser-rpn.lemon"
{
...
#line 1962 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 47: /* expr ::= OPERATOR_NOT expr */
#line 291 "./chalk-parser-rpn.lemon"
{
...
#line 1993 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 50: /* expr ::= expr expr OPERATOR_LEQ2 */
#line 307 "./chalk-parser-rpn.lemon"
{
...
#line 2004 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 51: /* expr ::= expr expr OPERATOR_GEQ */
#line 313 "./chalk-parser-rpn.lemon"
{
...
#line 2015 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 52: /* expr ::= expr expr OPERATOR_GEQ2 */
#line 319 "./chalk-parser-rpn.lemon"
{
...
#line 2026 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 53: /* expr ::= expr expr OPERATOR_LOW */
#line 325 "./chalk-parser-rpn.lemon"
{
...
#line 2037 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 54: /* expr ::= expr expr OPERATOR_LOW2 */
#line 331 "./chalk-parser-rpn.lemon"
{
...
#line 2048 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 55: /* expr ::= expr expr OPERATOR_GRE */
#line 337 "./chalk-parser-rpn.lemon"
{
...
#line 2059 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 56: /* expr ::= expr expr OPERATOR_GRE2 */
#line 343 "./chalk-parser-rpn.lemon"
{
...
#line 2070 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 57: /* expr ::= expr OPERATOR_EQU expr */
#line 349 "./chalk-parser-rpn.lemon"
{
...
#line 2081 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 58: /* expr ::= expr expr OPERATOR_EQU2 */
#line 355 "./chalk-parser-rpn.lemon"
{
...
#line 2092 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 59: /* expr ::= expr expr OPERATOR_NEQ */
#line 361 "./chalk-parser-rpn.lemon"
{
...
#line 2103 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 60: /* expr ::= expr expr OPERATOR_NEQ2 */
#line 367 "./chalk-parser-rpn.lemon"
{
...
#line 2114 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 61: /* expr ::= expr expr OPERATOR_SHL */
#line 373 "./chalk-parser-rpn.lemon"
{
...
#line 2125 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 62: /* expr ::= expr expr OPERATOR_SHL2 */
#line 379 "./chalk-parser-rpn.lemon"
{
...
#line 2136 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 63: /* expr ::= expr expr OPERATOR_SHR */
#line 385 "./chalk-parser-rpn.lemon"
{
...
#line 2147 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 64: /* expr ::= expr expr OPERATOR_SHR2 */
#line 391 "./chalk-parser-rpn.lemon"
{
...
#line 2158 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 65: /* expr ::= expr expr OPERATOR_AND */
#line 397 "./chalk-parser-rpn.lemon"
{
...
#line 2169 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 66: /* expr ::= expr expr OPERATOR_AND2 */
#line 403 "./chalk-parser-rpn.lemon"
{
...
#line 2180 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 67: /* expr ::= expr expr OPERATOR_OR */
#line 409 "./chalk-parser-rpn.lemon"
{
...
#line 2191 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 68: /* expr ::= expr expr OPERATOR_OR2 */
#line 415 "./chalk-parser-rpn.lemon"
{
...
#line 2202 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 69: /* expr ::= expr expr OPERATOR_XOR */
#line 421 "./chalk-parser-rpn.lemon"
{
...
#line 2213 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 70: /* expr ::= expr expr OPERATOR_XOR2 */
#line 427 "./chalk-parser-rpn.lemon"
{
...
#line 495 "./chalk-parser-rpn.lemon"
{
...
#line 2351 "./chalk-parser-rpn.c"
  yymsp[-2].minor.yy173 = yylhsminor.yy173;
        break;
      case 84: /* matrix_rows ::= matrix_row */
#line 506 "./chalk-parser-rpn.lemon"
{
...
#line 32 "./chalk-parser-rpn.lemon"

  NSLog(@"lemon parse failure");
  context.stop = YES;
#line 2463 "./chalk-parser-rpn.c"
...
#line 36 "./chalk-parser-rpn.lemon"

  NSLog(@"lemon syntax error");
  context.stop = YES;
#line 2486 "./chalk-parser-rpn.c"
