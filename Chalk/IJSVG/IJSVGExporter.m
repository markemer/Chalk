...
- (void)_moveAttributesToGroup
{
    @autoreleasepool {
        ...
        NSArray * groups = [_dom nodesForXPath:@"//g"
                                                         error:nil];
...
- (CGAffineTransform)affineTransformFromTransforms:(NSArray *)transforms
{
...
- (void)sortAttributesOnElement:(NSXMLElement *)element
{
    ...
    NSArray * sorted = [attributes sortedArrayUsingComparator:^NSComparisonResult(id obj1, id obj2) {
